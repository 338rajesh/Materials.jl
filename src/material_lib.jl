...
const epoxy_sample_1 = OrthotropicMaterial(
    tag="epoxy_sample_1",
    c_ij=Dict(
        :C11 => 3.86e09,  :C12 => 2.57e09,   :C13 => 2.57e09,
        :C22 => 3.86e09,  :C23 => 2.57e09,   :C33 => 3.86e09,
        :C44 => 0.64e09,  :C55 => 0.64e09,   :C66 => 0.64e09,
    ),
    e_ij = Dict(:e11=>0.0, :e21=>0.0, :e15=>0.0,),
    eps_ij = Dict(:eps_11=>0.0797e-09, :eps_22=>0.0797e-09, :eps_33=>0.0797e-09,),
)
...
const epoxy_sample_2 = OrthotropicMaterial(
    ...
    e_ij = Dict(:e11=>0.0, :e21=>0.0, :e15=>0.0,),
    eps_ij = Dict(:eps_11=>0.0372e-09, :eps_22=>0.0372e-09, :eps_33=>0.0372e-09,),
)

const PZT_5A = OrthotropicMaterial(
    tag="PZA-5A", c_ij=Dict(
        :C11 =>111.0e09,   :C12 => 75.2e09,   :C13 => 75.2e09,
        :C22 =>121.0e09,   :C23 => 75.4e09,   :C33 => 121.0e09,
        :C44 => 22.8e09,   :C55 => 21.1e09,   :C66 => 21.1e09,
    ),
    e_ij = Dict(:e11=>15.8, :e21=>-5.4, :e15=>12.3,),
    eps_ij = Dict(:eps_11=>7.35e-09, :eps_22=>8.11e-09, :eps_33=>8.11e-09,),
)
...
const PZT_7A = OrthotropicMaterial(
    ...
    eps_ij = Dict(:eps_11=>2.079e-09, :eps_22=>4.065e-09, :eps_33=>4.065e-09,),
)
...
const PZT_4 = OrthotropicMaterial(
    ...
    eps_ij = Dict(:eps_11=>5.61975e-09, :eps_22=>6.4605e-09, :eps_33=>6.4605e-09,),
)
...
const PZT_6B = OrthotropicMaterial(
    ...
    eps_ij = Dict(:eps_11=>3.4e-09, :eps_22=>3.6e-09, :eps_33=>3.6e-09,),
)
...
const PZT_8 = OrthotropicMaterial(
    ...
    eps_ij = Dict(:eps_11=>5.1507e-09, :eps_22=>7.9473e-09, :eps_33=>7.9473e-09,),
)
